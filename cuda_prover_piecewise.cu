        ...
        const char *preprocessed_path)
{
    ...
    G1 *evaluation_Bt1; G2 *evaluation_Bt2; G1 *evaluation_Lt;
    ...
    for(int i = 0; i < 3; i++) {
      if(i == 0) {
        ...
        evaluation_Bt1 = B::read_pt_ECp(out_B1.get());
        ...
        evaluation_Bt2 = B::read_pt_ECpe(out_B2.get());
        ...
        evaluation_Lt = B::read_pt_ECp(out_L.get());
